...
def podologo_list(request):
    ...
    return render(request, "core/podologo_list.html", contexto)
...
def podologo_form(request):
    ...
    return render(request, "core/podologo_form.html", {"form": form})


def paciente_list(request):
    consulta = models.Paciente.objects.all()
    contexto = {"pacientes": consulta}
    return render(request, "core/paciente_list.html", contexto)
